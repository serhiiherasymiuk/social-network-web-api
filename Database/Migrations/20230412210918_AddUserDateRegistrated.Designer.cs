...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230412210918_AddUserDateRegistrated")]
    partial class AddUserDateRegistrated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.GroupChatMessage", b =>
                {
                    b.HasOne("Core.Entities.GroupChat", "GroupChat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Core.Entities.IndividualChatMessage", b =>
                {
                    b.HasOne("Core.Entities.IndividualChat", "IndividualChat")
                        .WithMany("Messages")
                    ...
                    b.HasOne("Core.Entities.User", "Sender")
                        .WithMany("IndividualChatMessages")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GroupChatUser", b =>
                {
                    b.HasOne("Core.Entities.GroupChat", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.Navigation("IndividualChatMessages");

                    b.Navigation("IndividualChats");
